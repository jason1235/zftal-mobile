...
//          showWindow("审核记录","<%=request.getContextPath()%>/manoeuvre/AuditStatus_list.html?query.manoeuvreInfo.guid="+id, 720, 540);
           ...
           // $("#searchForm").submit();
            goUrl("<%=request.getContextPath()%>/manoeuvre/AuditStatus_list.html?query.manoeuvreInfo.guid="+id);
        }
        ...
        function showDtl(id){
            ...
            //$("#searchForm").submit();
            goUrl("<%=request.getContextPath()%>/manoeuvre/manoeuvre_show.html?listType=${listType}&query.guid="+id);
        }
 ...
 <form action="" name="searchForm" id="searchForm" method="post" onsubmit="searchForm_submit();return false;">
