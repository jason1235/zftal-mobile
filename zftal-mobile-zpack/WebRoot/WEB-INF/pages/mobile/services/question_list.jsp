...
<html>
  <head>
    ...
    $(function(){
     ...
     $("#btn_ck").click(function(){//功能条编辑按钮
            ...
            window.location.href = _path+"/serviceManager/question_toModifyQuestion.html?query.papermainid="+papermainid;
     });
     ...
     $("#btn_sh").click(function(){//功能条编辑按钮
         ...
         $.post("<%=request.getContextPath() %>/serviceManager/question_checkHasQue.html", 
    			 "query.papermainid="+papermainid, function(data){
				if(data.success){
			         window.location.href = _path+"/serviceManager/question_toShenHe.html?query.papermainid="+papermainid;
				}else{
     ...
     $("#btn_zj").click(function(){//功能条增加按钮
    	 var url = _path+"/serviceManager/question_toadd.html";
     ...
     $("#btn_jg").click(function(){//功能条增加按钮
    	 ...
    	 var papermainid = $("input[name='id']:checked").val();
    	 window.open(_path+"/serviceManager/question_getExamResult.html?papermainid="+papermainid);  
     });
     ...
     $("#btn_sc").click(function(){//功能条删除按钮
    	 ...
    	 var papermainid = $("input[name='id']:checked").val();
    	 $.post("<%=request.getContextPath() %>/serviceManager/question_remove.html", $("#form_edit").serialize(), function(data){
     ...
     $("#btn_anwser").click(function(){//功能条删除按钮
    	 ...
    	 var papermainid = $("input[name='id']:checked").val();
    	 window.open("<%=request.getContextPath() %>/serviceManager/question_answerList.html?query.papermainid="+papermainid);
     });
     ...
     $("#btn_ty").click(function(){//功能条删除按钮
    	 ...
    	 var papermainid = $("input[name='id']:checked").val();
    	 $.post("<%=request.getContextPath() %>/serviceManager/question_control.html", 
  ...
  <div class="container_ydht sl_all_bg">
      ...
      <form action="<%=request.getContextPath() %>/serviceManager/question_list.html" name="search" id="form_edit" method="post">
