...
<%@ include file="/commons/hrm/head_v5.ini" %>
    ...
    $(function(){
		...
		$("#btn_zj").click(function(){
			...
			var url = "<%=request.getContextPath()%>/serviceManager/twoQuestion_addType.html?model.papermainid="+papermainid;
	    	 $("#myModal_toji").find(".modal-content").width(750);
	         $("#myModal_toji").find(".modal-content").height(592);
	         $("#myFrame").height(592);
	         $("#myFrame").attr("src", url);
		...
		$("#list_body button").click(function(){
			...
			$.post(_path+"/serviceManager/twoQuestion_removeQuestion.html","questionid="+questionid,function(data){
