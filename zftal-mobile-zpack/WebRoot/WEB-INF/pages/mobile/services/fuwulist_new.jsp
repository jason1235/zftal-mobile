...
<html>
  <head>
    ...
    function selectAllOrCancel(obj,name){//全选狂操作
   	...
   	function doRight(){
   		...
   		$.post(_path+"/serviceManager/fwdyjs_add.html",$("#search").serialize(),function(data){
                if(data.success){
                	$("#search").submit();
                }else{
                    alert(data.text);
   	...
   	function doLeft(){
   		...
   		$.post(_path+"/serviceManager/fwdyjs_remove.html",$("#search").serialize(),function(data){
                if(data.success){
                	$("#search").submit();
                }else{
                    alert(data.text);
  ...
  <jsp:include page="../../globalweb/modal.jsp" flush="true"></jsp:include>
    <form action="<%=request.getContextPath() %>/serviceManager/fwdyjs_fpfu.html" name="search" id="search" method="post">
  <div class="container sl_all_bg" style="width: 100%;">
    ...
    <div class="toolbox" style="border: 0;padding: 0;margin: 0">
        <div class="btn-group" id="but_ancd">
            ...
            <span type="button" class="btn btn-default" id="btn_zj">当前角色为“<font color="green">${jsglModel.jsmc }</font>”，应用中心服务权限分配</span>
        </div>
    </div>
<br>
    <!-- Modal -->
            ...
            <table class="table table-bordered table-hover">
                ...
                <tr class="">
                    ...
                    <th colspan="3" style="text-align: center">
                        <font style="font-weight:bold;">未分配服务选项</font>
                    </th>
                </tr>
        ...
        <div class="col-sm-5" style="float: right;height: 480px;margin-bottom: 5px;color: #799bb5;overflow-x: hidden;overflow-y: scroll;margin-right: 15px;padding-right: 0px;border-color: #000;">
            ...
            <table class="table table-bordered table-hover">
                ...
                <tr class="">
                    ...
                    <th colspan="3" style="text-align: center">
                        <font style="font-weight:bold;">已分配服务选项</font>
                    </th>
                </tr>
