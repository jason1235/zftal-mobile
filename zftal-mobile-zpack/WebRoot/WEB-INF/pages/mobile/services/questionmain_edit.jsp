...
<style>
    ...
    $(function(){
        $("#save_btn").click(function(){
            ...
            $.post(_path+"/serviceManager/question_save.html",$("#form_edit").serialize(),function(data){
                if(data.success){
                	
                	parent.location.href = _path+"/serviceManager/question_toModifyQuestion.html?query.papermainid="+data.id+"&op=add";
                }else{
