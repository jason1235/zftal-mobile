...
//              $.post("<%=request.getContextPath() %>/market/market_htDelMarketComment.html?commentQuery.id="+id, null, function(data){
...
//						}, "json");
                ...
                $.ajax({
                	type:"post",
                	url:"<%=request.getContextPath() %>/market/market_htDelMarketComment.html",
                	data:{
                		id:$($check).val()
                	},
