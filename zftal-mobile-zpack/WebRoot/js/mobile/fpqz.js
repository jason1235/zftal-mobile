...
var WfpGrid = Class.create(BaseJqGrid_mobile_fpyh,{  
		        ...
		        colModel:[
				     ...
				     {label:'学院',name:'academy', index: 'academy',align:'center'},
				     {label:'班级',name:'classgrade', index: 'classgrade',align:'center'},
				     {label:'年级',name:'grade', index: 'grade',align:'center'},
...
function searchResult(){
	...
	map["member.academy"] = jQuery('#academy').val();
	map["member.classgrade"] = jQuery('#classgrade').val();
	map["member.grade"] = jQuery('#grade').val();
	map["member.sex"] = jQuery('#sex').val();
