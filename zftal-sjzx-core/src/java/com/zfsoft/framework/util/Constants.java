...
public class Constants {
	 ...
	 *
	 * @since 2012-12-5 上午11:19:56
	 * @author liuchaoyong
	 * @version 1.0
	 */
	public static final String WJGL_WJLX_EXCEL = "EXCEL";// excel: 文件类型
	public static final String WJGL_WJLX_TXT = "TXT";// txt: url地址类型
	public static final String JOB_GROUP="JOBGROUP";
	public static final String  XTMESSAGE_SJK_TYPE ="SJK" ;  //数据库状态消息
	public static final String  XTMESSAGE_YYFWQ_TYPE ="YYFWQ" ;  //交换服务状态消息
	public static final String  XTMESSAGE_JHRZ_TYPE ="JHRZ" ;  //交换日志状态消息

	//信息标准
	public static final String  XXBZ_GJ ="GJ" ;  //国家信息标准
	public static final String  XXBZ_XX ="XX" ;  //学校执行标准
	public static final String  XXBZ_GJ_DM ="GJ_DM" ;  //国家信息标准--代码集
	public static final String  XXBZ_XX_DM ="XX_DM" ;  //学校执行标准--代码集
	public static final String  XXBZ_GJ_SJ ="GJ_SJ" ;  //国家信息标准--数据集
	public static final String  XXBZ_XX_SJ ="XX_SJ" ;  //学校执行标准--数据集
