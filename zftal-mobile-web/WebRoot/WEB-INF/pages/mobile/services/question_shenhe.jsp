...
<%@ include file="/commons/hrm/head_v5.ini" %>
    ...
    function deleteResult(result){
        ...
        var papermainid = $("input[name='model.papermainid']").val();
        $.post("<%=request.getContextPath()%>/serviceManager/question_deleteQz.html","qzid="+qzidList+"&papermainid="+papermainid ,function(data){
            if(data.success){
           		$("#qzmc").val(data.qzmc);
		        //$("#qzid").val(qzidList);
		        //$("#myModal_toji").modal("hide");
...
<jsp:include page="../../globalweb/alert.jsp" flush="true"></jsp:include>
    <form action="<%=request.getContextPath()%>/serviceManager/question_saveAll.html" name="search" id="form_edit" method="post">
        <!-- top -->
