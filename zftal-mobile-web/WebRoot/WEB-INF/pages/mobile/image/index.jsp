	...
	-->
        ...
        /**检查图片上传类型*/          
         function checkImgType(obj){   
          ...
          if (endIndex == -1)    
            tag = false;   
          var imageFileName = imgFilePath.substr(imgFilePath.lastIndexOf("\\")+1,imgFilePath.lastIndexOf("."));   
		...
		<form name=form1 method=post enctype="multipart/form-data"
			...
			<div style="margin-left: 35%; margin-top: 20%">
				<table width="100%" border="0" align="center" cellpadding="0"
					...
					<tr>
						<td width="80%">
							<input type="file" name="imgFile" id="imgFile" maxlength="160"
								onchange="checkImgType(this);" width="300px" />
							&nbsp;
						</td>
					</tr>
				</table>
