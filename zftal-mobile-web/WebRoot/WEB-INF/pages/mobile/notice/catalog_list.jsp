...
<html>
	...
	<body>
		...
		<form id="form_list" action="<%=request.getContextPath() %>/gggl/catalog_list.html" method="post">
  ...
  <div class="formbox">
    ...
    <h3 class="datetitle_01">
    	<span>待办消息管理<font color="#0457A7" style="font-weight:normal;"> </font></span>
    </h3>
<!--标题end-->
		...
		var heightOffset= 200;
			...
			if (enableMsg != '') {
				...
				$('#list_body tr').bind('dblclick',function(){
					...
					showWindow("修改","<%=request.getContextPath()%>/gggl/catalog_modify.html?query.id=" + id, 750,heightOffset);
				});
			});
		    //heightOffset+=230;
		    $("#btn_zj").click(function(){
					showWindow("增加","<%=request.getContextPath()%>/gggl/catalog_add.html", 750,heightOffset);
				});
			 ...
			 var checked=$("input[id='id']:checked");
				...
				var checked=$("input[id='id']:checked");
					...
					$("#why_sure").click(function(){
						$.post("<%=request.getContextPath() %>/gggl/catalog_control.html?query.id="+id + "&" + arg, null, function(data){
