...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <body>
    ...
    <form id="form_edit">
        ...
        <input type="hidden" name="marketType.id" value="${id}"/>
        <div class="sl_mod modal-content" style="border:none">
            <div class="modal-header">
                ...
                <h4 class="modal-title text-left" id="myModalLabel">类型管理</h4>      
            </div>
            <div class="modal-body">
            	...
            	<div class="tab" style="clear: both;">
            		<table width="100%"  border="0" class="formlist" cellpadding="0" cellspacing="0">
            			<tbody>
		                   <tr id="titleTr">
		                        <th><span class="red">*</span>类型名称:</th>
		                        <td>
		                         <input id="titleInput" type="text" name="marketType.name" maxlength="32" placeholder="不要超过32个字符哦(^_^)" 
		                         	class="form-control" value="${marketType.name}" />
		                        </td>
		                    </tr>
        ...
        <script type="text/javascript">
			$(function(){
				...
				$("#save_btn").click(function(){
					...
					var url = "<%=request.getContextPath()%>/market/market_saveMarketType.html"
					$.ajax({
						type: 'POST',
						dataType:"text",
						url: url,
						...
						success: function(data){
							...
							if(obj.flag == "true" ){
								...
								openAlert(obj.msg, "s","auto", function(){
								  location.href = _path + "/market/market_htTypeList.html";
							    });
							}else{
								errorAlert(obj.msg);
							}
