...
<html>
	...
	<body>
	    ...
	    <form id="form_list" role="form" action="<%=request.getContextPath() %>/market/market_htTypeList.html" method="post">
		...
		<script type="text/javascript">
			...
			$("#btn_zj").click(function(){
		    	location.href="<%=request.getContextPath()%>/market/market_htAddType.html";
			});
			...
			$("#btn_xg").click(function(){
	    	 	...
	    	 	var url = _path+"/market/market_htAddType.html?id="+id;
            	location.href=url;
			});
		     ...
		     $("#btn_sc").click(function(){
                    ...
                    $("#why_sure").click(function(){
                    	...
                    	$.ajax({
							type: 'POST',
							dataType:"text",
							url: "<%=request.getContextPath() %>/market/market_htDelType.html",
							data: {"id":id},
