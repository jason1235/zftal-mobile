...
<html>
  <head>
    ...
    $(function(){
     ...
     $("#btn_detail").click(function(){//功能条增加按钮
    	 ...
    	 var detailUrl = $('input[name="id"]:checked').closest("tr").find("input[name='detailUrl']").val();
  ...
  <div class="container_ydht sl_all_bg">
      ...
      <form action="suggest/suggest_outList.html" name="search" id="search" method="post">
          ...
          <table class="table table-striped sl_all_bg table-bordered text-left" >
            ...
            <tbody id="list_body" >
                <s:iterator value="suggestList" var="menu" status="st">
                <tr name="tr" class="data pxtr">
                    <td>
                    	<input type="hidden" name="detailUrl" value="${menu.detailUrl }"/>
