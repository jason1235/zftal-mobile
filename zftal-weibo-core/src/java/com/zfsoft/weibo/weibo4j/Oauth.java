package com.zfsoft.weibo.weibo4j;
...
import com.zfsoft.weibo.weibo4j.http.BASE64Encoder;
...
public class Oauth extends Weibo{
	...
	public static String access_token = "2.00_Vwu1GzHpwXC1a356af712dqXfTC";
	...
	public String getCancel(String access_token){
		return WeiboConfig.getValue("authorizeURL").trim() + "?access_token=";
	}
}
