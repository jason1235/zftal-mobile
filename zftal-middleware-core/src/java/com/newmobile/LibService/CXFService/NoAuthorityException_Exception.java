...
public class NoAuthorityException_Exception extends Exception {
    ...
    private com.newmobile.LibService.CXFService.NoAuthorityException noAuthorityException;
    ...
    public NoAuthorityException_Exception(String message, com.newmobile.LibService.CXFService.NoAuthorityException noAuthorityException) {
        super(message);
        this.noAuthorityException = noAuthorityException;
    }

    public NoAuthorityException_Exception(String message, com.newmobile.LibService.CXFService.NoAuthorityException noAuthorityException, Throwable cause) {
        super(message, cause);
        this.noAuthorityException = noAuthorityException;
    }

    public com.newmobile.LibService.CXFService.NoAuthorityException getFaultInfo() {
