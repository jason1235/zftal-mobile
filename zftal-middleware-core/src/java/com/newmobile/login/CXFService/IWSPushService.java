 ...
 * 2016-12-20T14:46:22.024+08:00
 * Generated source version: 2.6.0
 * 
 */
@WebServiceClient(name = "IWSPushService", 
                  wsdlLocation = "http://10.71.33.72:8088/zftal-mobile/service/IWSPushService?wsdl",
...
public class IWSPushService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://10.71.33.72:8088/zftal-mobile/service/IWSPushService?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(IWSPushService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "http://10.71.33.72:8088/zftal-mobile/service/IWSPushService?wsdl");
        }
        WSDL_LOCATION = url;
    }
