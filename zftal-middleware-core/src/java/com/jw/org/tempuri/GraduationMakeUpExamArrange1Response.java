 ...
 *       &lt;sequence>
 *         &lt;element name="GraduationMakeUpExamArrange1Result" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class GraduationMakeUpExamArrange1Response {
    ...
    /**
     * ��ȡgraduationMakeUpExamArrange1Result���Ե�ֵ��
     * 
     * @return
     *     possible object is
    ...
    /**
     * ����graduationMakeUpExamArrange1Result���Ե�ֵ��
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link String }{@code >}
