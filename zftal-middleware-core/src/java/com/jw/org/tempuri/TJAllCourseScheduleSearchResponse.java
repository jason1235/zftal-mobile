 ...
 *       &lt;sequence>
 *         &lt;element name="TJAllCourseScheduleSearchResult" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class TJAllCourseScheduleSearchResponse {
    ...
    /**
     * ��ȡtjAllCourseScheduleSearchResult���Ե�ֵ��
     * 
     * @return
     *     possible object is
    ...
    /**
     * ����tjAllCourseScheduleSearchResult���Ե�ֵ��
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link String }{@code >}
