 ...
 *       &lt;sequence>
 *         &lt;element name="TJCourseScheduleSearchResult" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class TJCourseScheduleSearchResponse {
    ...
    /**
     * ��ȡtjCourseScheduleSearchResult���Ե�ֵ��
     * 
     * @return
     *     possible object is
    ...
    /**
     * ����tjCourseScheduleSearchResult���Ե�ֵ��
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link String }{@code >}
