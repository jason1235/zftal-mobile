 ...
 *       &lt;sequence>
 *         &lt;element name="TeacherSuperviseArrangementSearchResult" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class TeacherSuperviseArrangementSearchResponse {
    ...
    /**
     * ��ȡteacherSuperviseArrangementSearchResult���Ե�ֵ��
     * 
     * @return
     *     possible object is
    ...
    /**
     * ����teacherSuperviseArrangementSearchResult���Ե�ֵ��
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link String }{@code >}
