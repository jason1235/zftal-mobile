 ...
 *       &lt;sequence>
 *         &lt;element name="ClassRoomCategoryInfoResult" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class ClassRoomCategoryInfoResponse {
    ...
    /**
     * ��ȡclassRoomCategoryInfoResult���Ե�ֵ��
     * 
     * @return
     *     possible object is
    ...
    /**
     * ����classRoomCategoryInfoResult���Ե�ֵ��
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link String }{@code >}
