 ...
 *       &lt;sequence>
 *         &lt;element name="CourseScheduleSearch_WXResult" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class CourseScheduleSearchWXResponse {
    ...
    /**
     * ��ȡcourseScheduleSearchWXResult���Ե�ֵ��
     * 
     * @return
     *     possible object is
    ...
    /**
     * ����courseScheduleSearchWXResult���Ե�ֵ��
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link String }{@code >}
