 ...
 *       &lt;sequence>
 *         &lt;element name="TeacherSuperviseArrangementSearch1Result" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class TeacherSuperviseArrangementSearch1Response {
    ...
    /**
     * ��ȡteacherSuperviseArrangementSearch1Result���Ե�ֵ��
     * 
     * @return
     *     possible object is
    ...
    /**
     * ����teacherSuperviseArrangementSearch1Result���Ե�ֵ��
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link String }{@code >}
