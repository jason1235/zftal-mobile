 ...
 *
 */
public class QQMenuUtil {

    private static Logger log = LoggerFactory.getLogger(QQMenuUtil.class);
    /**
     * 创建菜单
     * @param menu
     * @param accessToken
    ...
    public static boolean createMenu(Menu menu, String accessToken) {
        ...
        String url = QQConstants.MENU_CREATE_URL.replace("ACCESS_TOKEN", accessToken);
    ...
    public static boolean createMenu(String jsonMenu, String accessToken) {
        ...
        boolean result = false;
        String url = QQConstants.MENU_CREATE_URL.replace("ACCESS_TOKEN", accessToken);
        log.info("创建菜单，url:{} menu:{}" , url ,jsonMenu);
        JSONObject jsonObject = WeChatCommonUtil.httpsRequest(url, "POST", jsonMenu);
    ...
    public static String getMenu(String accessToken) {
        ...
        String result = null;
        String requestUrl = QQConstants.MENU_GET_URL.replace("ACCESS_TOKEN", accessToken);
    ...
    public static boolean deleteMenu(String accessToken) {
        ...
        boolean result = false;
        String requestUrl = QQConstants.MENU_DELETE_URL.replace("ACCESS_TOKEN", accessToken);
        JSONObject jsonObject = WeChatCommonUtil.httpsRequest(requestUrl, "GET", null);
