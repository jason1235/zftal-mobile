 ...
 * @version V1.0.0
 */
public class WeChatMenuAction extends HrmAction{
...
//		menuInfo="{\"menu\":{\"button\":[{\"type\":\"click\",\"name\":\"今日歌曲\",\"key\":\"V1001_TODAY_MUSIC\",\"sub_button\":[]},{\"type\":\"click\",\"name\":\"歌手简介\",\"key\":\"V1001_TODAY_SINGER\",\"sub_button\":[]},{\"name\":\"菜单\",\"sub_button\":[{\"type\":\"view\",\"name\":\"搜索\",\"url\":\"http://www.soso.com/\",\"sub_button\":[]},{\"type\":\"view\",\"name\":\"视频\",\"url\":\"http://v.qq.com/\",\"sub_button\":[]},{\"type\":\"click\",\"name\":\"赞一下我们\",\"key\":\"V1001_GOOD\",\"sub_button\":[]}]}]}}";
		...
		AccessToken t =WeChatTokenUtil.getAccessToken(appId, appSecret,false);
		menuInfo=WeChatMenuUtil.getMenu(t.getAccessToken());
		if(StringUtil.isEmpty(menuInfo))
			menuInfo = "{\"menu\":{\"button\":[]}}";
		getValueStack().set("appid", appId);
		getValueStack().set("businessType", WeChatSystemHolder.getPropertiesValue("businessType"));
		getValueStack().set("ssoserverLink", WeChatSystemHolder.getPropertiesValue("ssoserverLink"));
		return "list";
	}
	...
	public String save(){
		...
		if(!WeChatMenuUtil.createMenu(menuInfo, t.getAccessToken()))
