...
import com.zfsoft.mobile.webservices.cxf.service.IWSPushService;
 ...
 * @version V1.0.0
 */
@WebService(endpointInterface="com.zfsoft.mobile.webservices.cxf.service.IWSPushService",serviceName="WSPushService") 
public class WSPushServiceImpl implements IWSPushService {
	...
	public String SetUserIdAndRegistrationId(String parameterList, String sign) {
		System.out.println(Encrypt.encrypt(parameterList+PushEncryptWord));
		if(StringUtil.isEmpty(parameterList)||parameterList.split("&").length!=4){
			return errorInfo("002", "参数错误");
		}
		...
		pushRegistration.setSbType(param[3]);
		try{
...
//		System.out.println(Encrypt.encrypt(parameterList+PushEncryptWord));
	...
	public static void main(String[] args) {
		...
		//String aaa ="{\"timeToLive\":\"1800\",\"tsdx\":[\"zkzxy\"],\"tsdxlx\":\"ALIAS\",\"tsfs\":\"1\",\"tsnr\":\"123\",\"tspt\":\"ALL\",\"appType\":\"YDXY\",\"tsry\":\"zf01\",\"extras\":{\"sys_type\" : \"001\",\"msg_type\" : \"1\",\"func_type\" : \"1\",\"this_unread\" : \"1\",\"login_flg\" : \"1\",\"send_time\" : \"2017/58/11 06:58:31\"\"xtbm\" : \"xg\",\"webURL\" : \"http://localhost/ydxg/ydxg_znxgl_znxcx.do\",\"webNAME\" : \"学工站内信\"}}";
