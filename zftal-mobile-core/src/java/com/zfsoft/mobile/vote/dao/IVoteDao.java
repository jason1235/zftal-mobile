package com.zfsoft.mobile.vote.dao;
...
public interface IVoteDao {
	 ...
	 * @return
	 */
	 List<VoteMainEntity> getList(VoteMainQuery query);
	 ...
	 * 移动后台投票列表
	 */
	 List<VoteMainEntity> getYdhtList(VoteMainQuery query);
	  ...
	  * @return
	  */
	 int getYdhtListCount(VoteMainQuery query);
