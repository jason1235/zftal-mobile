package com.zfsoft.mobile.MD5Util;

public class MD5UtilInAndroid {
	 /*
    ...
    /*
     * F, G, H
     * ,I是4个基本的MD5函数，在原始的MD5的C实现中，由于它们是简单的位运算，可能出于效率的考虑把它们实现成了宏，在java中，我们把它们实现成了private方法名字保持了原来C中的。
     */
    ...
    /*
     * byteHEX()，用来把一个byte类型的数转换成十六进制的ASCII表示，因为java中的byte的toString无法实现这一点，我们又没有C语言中的
    ...
    public static void main(String[] args) {
    	String str1 = "002XS0101255DAFF8EA19E6BAC86E040007F01004EA1468291188";
    	String str4 = getMD5ofStr(str1);
